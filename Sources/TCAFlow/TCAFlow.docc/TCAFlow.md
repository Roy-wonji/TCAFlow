...
UIKitNavigation과 SwiftUI를 결합해 push, sheet, fullScreenCover를 지원하며, 중첩된 coordinator(Nested Coordinator)도 지원합니다.

### 핵심 특징

- **Hashable 불필요** — Screen State에 `Equatable`만 요구
- **Hybrid Navigation** — UIKitNavigation 기반 push/pop과 SwiftUI presentation 결합
